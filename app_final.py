...
diagnosis_prompt = PromptTemplate(
    ...
    template=(
        ...
        "Lab Report Summary: {lab_report}\n\n"
        "Provide a comprehensive and empathetic diagnosis, including:"
        "- A clear statement of the likely condition(s)\n"
        "- An explanation of the probable causes and risk factors\n"
        "- Recommended next steps for the patient, such as further testing or treatment options\n"
        "- Advice on managing the condition and easing any discomfort\n"
        "- Reassurance and encouragement for the patient"
    ),
)
follow_up_prompt = PromptTemplate(
    ...
    template=(
        ...
        "Provide a thoughtful, empathetic, and informative response that:"
        "- Acknowledges the user's concerns\n"
        "- Offers additional context or clarification on the previous diagnosis or recommendations\n"
        "- Suggests next steps the user can take, such as consulting a medical professional\n"
        "- Encourages the user to continue their healthcare journey with confidence"
    ),
)

def get_diagnosis(symptoms, history, lab_report):
    """Generate an enhanced diagnosis with a more comprehensive and empathetic response."""
    with st.spinner("🔄 Analyzing symptoms and generating comprehensive diagnosis..."):
        return diagnosis_chain.run(symptoms=symptoms, history=history, lab_report=lab_report)

def handle__follow_up(follow_up_question, history):
    """Process follow-up questions with a more thoughtful and empathetic response."""
    with st.spinner("🔄 Processing your question..."):
        return follow_up_chain.run(follow_up=follow_up_question, history=history)

# Initialize LangChain Agents with Enhanced Prompts
